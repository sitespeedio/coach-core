  ...
  BROWSERS.forEach(function(browser) {
    describe('browser: ' + browser, async function() {
      ...
      it('We should be able to check if the page has a description meta tag', function() {
        return runner.run('metaDescription.js').then(result => {
