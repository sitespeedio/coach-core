(function (util) {
  ...
  if (typeof globalThis.jQuery === 'function') {
    ...
    let keepRef = globalThis.$;
    versions.push(globalThis.jQuery.fn.jquery);
    let old = globalThis.jQuery;
    while (old.fn && old.fn.jquery) {
      old = globalThis.jQuery.noConflict(true);
      if (
        !globalThis.jQuery ||
        !globalThis.jQuery.fn ||
        !globalThis.jQuery.fn.jquery
      ) {
        break;
      }
      if (old.fn.jquery === globalThis.jQuery.fn.jquery) {
        break;
      }
      versions.push(globalThis.jQuery.fn.jquery);
    }
    globalThis.jQuery = globalThis.$ = keepRef;
  }
